        ...
        prm.enter_subsection ("Fastscape");
        {
          ...
          prm.enter_subsection ("Erosional parameters");
          {
            ...
            prm.declare_entry("Orographic elevation control", "2000",
                              Patterns::Integer(),
                              "Anything above this height has a reduction in erodibility.");
            prm.declare_entry("Orographic wind barrier height", "500",
                              Patterns::Integer(),
                              "Once terrain reaches this height, one side has reduced erodibility.");
            prm.declare_entry("Elevation reduction", "1",
                              Patterns::Double(),
                              "Amount to reduce kf and kd past elevation.");
            prm.declare_entry("Wind barrier reduction", "1",
                              Patterns::Double(),
                              "Diffusivity of sediment.");
      ...
      prm.enter_subsection ("Mesh deformation");
      {
        prm.enter_subsection("Fastscape");
        {
          ...
          prm.enter_subsection("Erosional parameters");
          {
            ...
            reduc_mmax = prm.get_double("Elevation reduction");
            reduc_wb = prm.get_double("Wind barrier reduction");
