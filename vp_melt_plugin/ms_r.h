...
#ifndef _aspect_material_model_melt_simple_co2_h
#define _aspect_material_model_melt_simple_co2_h
...
namespace aspect
{
  namespace MaterialModel
  {
     ...
     */
    template <int dim>
    class MeltSimpleCo2 : public MaterialModel::MeltInterface<dim>,
