...
namespace aspect
{
  namespace MaterialModel
  {
    ...
    template <int dim>
    void
    ViscoPlasticReact<dim>::declare_parameters (ParameterHandler &prm)
    {
      prm.enter_subsection("Material model");
      {
        prm.enter_subsection ("Visco Plastic React");
        {
    ...
    template <int dim>
    void
    ViscoPlasticReact<dim>::parse_parameters (ParameterHandler &prm)
    {
      prm.enter_subsection("Material model");
      {
        prm.enter_subsection ("Visco Plastic React");
        {
          ...
          co_model.initialize_simulator (this->get_simulator());
          co_model.parse_parameters(prm);
    ...
    template <int dim>
    void
    ViscoPlasticReact<dim>::create_additional_named_outputs (MaterialModel::MaterialModelOutputs<dim> &out) const
    {
...
namespace aspect
{
  namespace MaterialModel
  {
    ASPECT_REGISTER_MATERIAL_MODEL(ViscoPlasticReact,
                                   "visco plastic react",
