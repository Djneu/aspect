...
namespace aspect
{
  namespace MaterialModel
  {
    ...
    template <int dim>
    void
    MeltSimpleCo2<dim>::declare_parameters (ParameterHandler &prm)
    {
    ...
    template <int dim>
    void
    MeltSimpleCo2<dim>::parse_parameters (ParameterHandler &prm)
    {
      prm.enter_subsection("Material model");
      {
        prm.enter_subsection("Melt simple co2");
    ...
    template <int dim>
    void
    MeltSimpleCo2<dim>::create_additional_named_outputs (MaterialModel::MaterialModelOutputs<dim> &out) const
    {
...
namespace aspect
{
  namespace MaterialModel
  {
    ASPECT_REGISTER_MATERIAL_MODEL(MeltSimpleCo2,
                                   "melt simple co2",
